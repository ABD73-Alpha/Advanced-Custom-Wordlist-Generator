"""
Targeted Wordlist Generator for Password Attacks

This script generates customized wordlists based on personal information,
company names, dates, and other elements. It supports mangling, leetspeak,
symbol insertions, and combining multiple elements to create highly targeted
password guesses.

Features:
- Combine up to 5 words (e.g. name, company, year)
- Use separators like '_', '-', '@', '.', ''
